          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="<?= base_url('User/ProfileController'); ?>">Kelola Profil</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?= base_url('Auth/ChangePasswordController'); ?>">Ganti Password</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
